...
export const heroCtaCopy = {
  header: "Starting your dream life shouldn't be stressful & confusing",
  subHeader: 'Let us handle it',
};

export const servicesCopy = {
  heading: 'End-to-end Spain Relocation Services',
  description: " Whether you're relocating, buying a home, or starting a business, we're here to help.",
  cards: [
    {
      id: 1,
...
export const weKnowSpainCopy = {
  ...
  descriptionTwo: "Local expertise isn't just an advantage in Spain—it's essential.",
};
...
export const ctaCopy = {
  heading: 'Your dream life is calling',
  description: 'Take the first step with a free 20-minute strategy call',
};

export const aboutCopy = {
  heading: 'About Fatima',
  content: [
    'Hola España is a relocation agency founded and led by Fatima Boukrim, a legally qualified professional with deep expertise in Spanish labour law, immigration, social security, and employment regulations.',
    'Trained at the Complutense University of Madrid in Law and Labour Relations and holding an MBA in Business Management, Fatima brings both legal insight and real-world business understanding to every client case.',
    'Authorized to represent individuals and companies before Spanish administrative and labour authorities, Hola España combines local legal knowledge, practical experience, and multilingual support to make relocation, employment, and immigration to Spain clear, secure, and stress-free.',
    'We provide reliable, client-focused solutions for those building a life or business in Spain.',
  ],
};
