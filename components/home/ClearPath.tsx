...
export default function ClearPath() {
  return (
    <Container size="full" id="path">
      ...
      <Container
        className="px-16"
        iconProps={{ icon: 'sun', iconClassName: 'text-sand-icon w-[325] h-[325] absolute top-0 left-0 -z-1 -translate-y-2 -translate-x-10' }}
      >
      ...
      <div className="relative -mx-0.5 max-w-[1880px] after:absolute after:bottom-0 after:h-[3px] after:w-full after:bg-black after:content-['']">
