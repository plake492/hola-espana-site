...
export default function Hero() {
  return (
    <Container
      size="full"
      className="relative flex min-h-[550px] w-full flex-col items-center justify-center overflow-hidden bg-black text-white sm:min-h-[max(85svh,550px)] md:min-h-[max(calc(100svh+250px),950px)]"
      id="hero"
    >
