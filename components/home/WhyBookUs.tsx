  ...
  return (
    <section className="bg-[#ede2d7]">
      ...
      <div className="bg-[#d2e4ec] px-4 pt-4 pb-18 min-[400px]:px-8 sm:pl-16">
        <h3 className="mb-12 block text-4xl sm:hidden">{whyChooseUsCopy.heading}</h3>
        <div className="block max-w-[1240px] grid-cols-[5fr_3fr] gap-4 min-[380px]:grid sm:mx-auto sm:grid-cols-[4fr_3fr] sm:gap-12 lg:gap-32">
          <div>
            <h3 className="mb-12 hidden text-4xl sm:block">{whyChooseUsCopy.heading}</h3>
              ...
              {whyChooseUsCopy.list.map((content, i) => (
                <li key={i} className="flex-1">
                  <div className="relative">
                    ...
                    <h4 className="text-md ms:text-2xl font-serif font-semibold italic">{content.title}</h4>
